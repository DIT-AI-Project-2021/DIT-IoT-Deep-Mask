...
* If all three conditions above are satisfied, the enterance gate will open. But If one of the three is not, warning sound is generated and the entrance gate will closed automatically.

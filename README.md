# AI-based Automated Unmanned Entrance Control System to defend COVID-19 
### Project Outline
...
* It provide IoT powered connectivity. So new functionalities can be extended through the Internet connection easily.
